				...
				<div id="weare">	
					...
					<div id="respons">
		                ...
		                <div id="doge">
							...
							<p> Enrico Trinco &egrave; il responsabile delle pagine "Chi Siamo", "Contattaci", "Log-in" del Javascript </p>
						</div>
		                
						<div id="nico">
							<h3>Nicola Carlesso </h3>
							<img id="nic" src="../images/nico.jpg">
                            <p> Nicola Carlesso &egrave; il responsabile del CSS desktop, mobile, stampa e della parte di sicurezza e relativo Javascrip.</p>	
                        </div>
