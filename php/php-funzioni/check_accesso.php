		...
		if($opendDBConnection == true){
				echo '<form action="php-funzioni/uscita.php" method="post">
					<p id="id_button_scrivi_esci">
						<input type="button" id="button_scrivi_articolo" value="Scrivi articolo" onclick="window.location.href=' ."'" ."new_articolo.php" ."'" .'"' .' alt="Entra nella sezione per modificare, scrivere ed eliminare articoli">
