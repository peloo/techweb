		...
		<div id="content_menu"> 
			...
			<div id="content">
				<div id="security">
					...
					<div>
						<p>Indicare il sesso, se si è a stomaco pieno o vuoto, e ilproprio peso</p>
						...
						<select id="bevanda">
							...
							<option value="digestivi">Digestivi, 25%</option>
							<option value="digestivi">Digestivi, 30%</option>
							<option value="superalcolici">Superalcolici, 35%</option>
							<option value="superalcolici">Superalcolici, 45%</option>
							<option value="superalcolici">Superalcolici, 60%</option>
							<option value="champagne/spumante">Champagne/Spumante, 11%</option>
							<option value="ready_to_drink">Ready to drink, 2.8%</option>
							<option value="ready_to_drink">Ready to drink, 5%</option>
						</select>
